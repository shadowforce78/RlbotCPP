...
#include <RLGymCPP/Rewards/CommonRewardsExtra.h>
#include <RLGymCPP/Rewards/ZeroSumReward.h>
#include <RLGymCPP/Rewards/AerialReward.h>
...
EnvCreateResult EnvCreateFunc(int index)
{
	...
	// At low (<500m) steps, the bot should learn basics before tricks too much flip resets, etc
...
int main(int argc, char *argv[])
{
	...
	cfg.ppo.miniBatchSize = 25'000; // Lower this if too much VRAM is being allocated
